...
# all
python src/train_imagenet16.py --log_dir /mnt/data/pretrained_models/blur-training/imagenet16 --mode all -s 1 -n vone_alexnet_all_s01
python src/train_imagenet16.py --log_dir /mnt/data/pretrained_models/blur-training/imagenet16 --mode all -s 2 -n vone_alexnet_all_s02
python src/train_imagenet16.py --log_dir /mnt/data/pretrained_models/blur-training/imagenet16 --mode all -s 3 -n vone_alexnet_all_s03
