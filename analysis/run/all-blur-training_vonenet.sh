#cd ../lowpass_acc
#python compute_lowpass_acc.py vone_alexnet 16 imagenet16 all-blur-training
#python compute_plot_lowpass_confusion_matrix.py vone_alexnet 16 imagenet16 all-blur-training
...
#cd ../bandpass_acc
#python compute_bandpass_acc.py vone_alexnet 16 imagenet16 all-blur-training
#python compute_bandpass_confusion_matrix.py vone_alexnet 16 imagenet16 all-blur-training
#
#cd ../rsa/bandpass/rsm
